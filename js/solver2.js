//-------------------------------
let iterationsBottom = 0;
let iterationsRight = 0;
...
displaySolution = (res) => {
  ...
  console.log("iterationsBottom = " + iterationsBottom);

  console.log("iterationsRight = " + iterationsRight);

  console.log("iterations = " + (iterationsRight + iterationsBottom));
};
